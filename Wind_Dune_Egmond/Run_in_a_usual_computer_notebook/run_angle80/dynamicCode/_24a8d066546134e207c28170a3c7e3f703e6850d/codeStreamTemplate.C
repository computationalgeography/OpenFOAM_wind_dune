...
//{{{ begin codeInclude
#line 76 "/home/saeb/OpenFoam/Wind_Dune_profile_cyc_snappyHexMesh_3_14April2023/run_angle80/processor0/0/U/boundaryField/inlet/#codeStream"
#include "fvCFD.H"
			#include <math.h>   ///////////
			#include <cmath>    //////////
//}}} end codeInclude
...
extern "C"
{
    void codeStream_24a8d066546134e207c28170a3c7e3f703e6850d
    (
        Ostream& os,
    ...
    {
//{{{ begin code
        #line 92 "/home/saeb/OpenFoam/Wind_Dune_profile_cyc_snappyHexMesh_3_14April2023/run_angle80/processor0/0/U/boundaryField/inlet/#codeStream"
const IOdictionary& d = static_cast<const IOdictionary&>
			...
			forAll(U, i)	//equivalent to for (int i=0; patch.size()<i; i++)
			{
				...
				double teta_wind_velocity_radian = (80*PI)/180;
