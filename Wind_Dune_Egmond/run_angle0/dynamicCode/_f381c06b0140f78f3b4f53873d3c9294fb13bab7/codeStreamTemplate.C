...
//{{{ begin codeInclude
#line 76 "/scratch/Saeb_OpenFoam/Wind_Dune_cyc_snappy_6April2023/run_angle0/processor0/0/U/boundaryField/inlet/#codeStream"
#include "fvCFD.H"
			#include <math.h>   ///////////
			#include <cmath>    //////////
//}}} end codeInclude
...
extern "C"
{
    ...
    {
//{{{ begin code
        #line 92 "/scratch/Saeb_OpenFoam/Wind_Dune_cyc_snappy_6April2023/run_angle0/processor0/0/U/boundaryField/inlet/#codeStream"
