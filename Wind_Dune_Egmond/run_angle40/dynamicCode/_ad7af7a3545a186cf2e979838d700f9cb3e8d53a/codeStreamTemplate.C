...
//{{{ begin codeInclude
#line 76 "/scratch/Saeb_OpenFoam/Wind_Dune_cyc_snappy_6April2023/run_angle40/processor0/0/U/boundaryField/inlet/#codeStream"
#include "fvCFD.H"
			#include <math.h>   ///////////
			#include <cmath>    //////////
//}}} end codeInclude
...
extern "C"
{
    void codeStream_ad7af7a3545a186cf2e979838d700f9cb3e8d53a
    (
        Ostream& os,
    ...
    {
//{{{ begin code
        #line 92 "/scratch/Saeb_OpenFoam/Wind_Dune_cyc_snappy_6April2023/run_angle40/processor0/0/U/boundaryField/inlet/#codeStream"
const IOdictionary& d = static_cast<const IOdictionary&>
			...
			forAll(U, i)	//equivalent to for (int i=0; patch.size()<i; i++)
			{
				...
				double teta_wind_velocity_radian = (40*PI)/180;
