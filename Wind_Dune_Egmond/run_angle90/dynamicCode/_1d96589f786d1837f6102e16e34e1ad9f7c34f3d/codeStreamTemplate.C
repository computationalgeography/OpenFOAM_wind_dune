...
//{{{ begin codeInclude
#line 76 "/home/saeb/OpenFoam/Wind_Dune_profile_cyc_snappyHexMesh_3_14April2023/run_angle90/processor0/0/U/boundaryField/inlet/#codeStream"
#include "fvCFD.H"
			#include <math.h>   ///////////
			#include <cmath>    //////////
//}}} end codeInclude
...
extern "C"
{
    void codeStream_1d96589f786d1837f6102e16e34e1ad9f7c34f3d
    (
        Ostream& os,
    ...
    {
//{{{ begin code
        #line 92 "/home/saeb/OpenFoam/Wind_Dune_profile_cyc_snappyHexMesh_3_14April2023/run_angle90/processor0/0/U/boundaryField/inlet/#codeStream"
const IOdictionary& d = static_cast<const IOdictionary&>
			...
			forAll(U, i)	//equivalent to for (int i=0; patch.size()<i; i++)
			{
				...
				double teta_wind_velocity_radian = (90*PI)/180;
