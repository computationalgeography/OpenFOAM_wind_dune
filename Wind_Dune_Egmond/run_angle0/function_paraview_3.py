...
def paraview_prob(bed_distance,bed_distance_prob0):
    ...
    prob_2_x=61.5      #60        #61.5   #62     #61
    prob_2_y=1.51      #0.44      #1.51   #2.05   #0.97
    prob_2_z=50
    ...
    # init the 'Fixed Radius Point Source' selected for 'ProbeType'
    probeLocation0.ProbeType.Center = [prob_0_x,prob_0_y+bed_distance_prob0, prob_0_z]
