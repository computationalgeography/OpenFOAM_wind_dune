...
//{{{ begin codeInclude
#line 76 "/scratch/Saeb_OpenFoam/Wind_Dune_cyc_snappy_6April2023/run_angle30/processor0/0/U/boundaryField/inlet/#codeStream"
#include "fvCFD.H"
			#include <math.h>   ///////////
			#include <cmath>    //////////
//}}} end codeInclude
...
extern "C"
{
    void codeStream_a486d7066f8edd3b0d82f81ba6631223748634f2
    (
        Ostream& os,
    ...
    {
//{{{ begin code
        #line 92 "/scratch/Saeb_OpenFoam/Wind_Dune_cyc_snappy_6April2023/run_angle30/processor0/0/U/boundaryField/inlet/#codeStream"
const IOdictionary& d = static_cast<const IOdictionary&>
			...
			forAll(U, i)	//equivalent to for (int i=0; patch.size()<i; i++)
			{
				...
				double teta_wind_velocity_radian = (30*PI)/180;
