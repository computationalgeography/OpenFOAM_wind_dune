...
def U_ratio_function(bed_distance):
    # trace generated using paraview version 5.10.1
    #import paraview
    #paraview.compatibility.major = 5
    #paraview.compatibility.minor = 10

    #from paraview.simple import resultfoam
    ...
    # prob bottom
    probeLocation1 = ProbeLocation(registrationName='ProbeLocation1', Input=resultfoam,
        ProbeType='Fixed Radius Point Source')

    # init the 'Fixed Radius Point Source' selected for 'ProbeType'
    probeLocation1.ProbeType.Center = [50,-5.08+bed_distance, 50.0]
    ...
    # create a new 'Probe Location'
    # prob mid
    probeLocation2 = ProbeLocation(registrationName='ProbeLocation2', Input=resultfoam,
        ProbeType='Fixed Radius Point Source')

    # init the 'Fixed Radius Point Source' selected for 'ProbeType'
    probeLocation2.ProbeType.Center = [75, 8.7+bed_distance, 50.0]
    ...
    # create a new 'Probe Location'
    # prob up
    probeLocation3 = ProbeLocation(registrationName='ProbeLocation3', Input=resultfoam,
        ProbeType='Fixed Radius Point Source')

    # init the 'Fixed Radius Point Source' selected for 'ProbeType'
    probeLocation3.ProbeType.Center = [101, 12.05+bed_distance, 50.0]
