...
//{{{ begin codeInclude
#line 76 "/scratch/Saeb_OpenFoam/Wind_Dune_cyc_snappy_6April2023/run_angle60/processor0/0/U/boundaryField/inlet/#codeStream"
#include "fvCFD.H"
			#include <math.h>   ///////////
			#include <cmath>    //////////
//}}} end codeInclude
...
extern "C"
{
    void codeStream_4c14191b8007ae35429c895a732f1264159dde3e
    (
        Ostream& os,
    ...
    {
//{{{ begin code
        #line 92 "/scratch/Saeb_OpenFoam/Wind_Dune_cyc_snappy_6April2023/run_angle60/processor0/0/U/boundaryField/inlet/#codeStream"
const IOdictionary& d = static_cast<const IOdictionary&>
			...
			forAll(U, i)	//equivalent to for (int i=0; patch.size()<i; i++)
			{
				...
				double teta_wind_velocity_radian = (60*PI)/180;
