...
//{{{ begin codeInclude
#line 76 "/home/saeb/OpenFoam/Wind_Dune_profile_cyc_snappyHexMesh_3_14April2023/run_angle89/processor0/0/U/boundaryField/inlet/#codeStream"
#include "fvCFD.H"
			#include <math.h>   ///////////
			#include <cmath>    //////////
//}}} end codeInclude
...
extern "C"
{
    void codeStream_b98ded06498a9fbb0f5e8d8afebf42dc066cba6f
    (
        Ostream& os,
    ...
    {
//{{{ begin code
        #line 92 "/home/saeb/OpenFoam/Wind_Dune_profile_cyc_snappyHexMesh_3_14April2023/run_angle89/processor0/0/U/boundaryField/inlet/#codeStream"
const IOdictionary& d = static_cast<const IOdictionary&>
			...
			forAll(U, i)	//equivalent to for (int i=0; patch.size()<i; i++)
			{
				...
				double teta_wind_velocity_radian = (89*PI)/180;
