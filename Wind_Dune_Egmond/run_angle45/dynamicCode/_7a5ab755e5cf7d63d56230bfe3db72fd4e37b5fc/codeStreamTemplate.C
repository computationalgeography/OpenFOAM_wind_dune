...
//{{{ begin codeInclude
#line 75 "/scratch/Saeb_OpenFoam/Wind_Dune_cyc_snappy_6April2023/run_angle45/processor0/0/nut/boundaryField/ground/#codeStream"
#include "fvCFD.H"
			#include <math.h>   ///////////
			#include <cmath>    //////////
//}}} end codeInclude
...
extern "C"
{
    ...
    {
//{{{ begin code
        #line 91 "/scratch/Saeb_OpenFoam/Wind_Dune_cyc_snappy_6April2023/run_angle45/processor0/0/nut/boundaryField/ground/#codeStream"
